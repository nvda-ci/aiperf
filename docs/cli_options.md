...
<br>_Choices: [`chat`, `cohere_rankings`, `completions`, `embeddings`, `hf_tei_rankings`, `huggingface_generate`, `image_generation`, `nim_rankings`, `solido_rag`, `template`]_
<br>_Default: `chat`_
