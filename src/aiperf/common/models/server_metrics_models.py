...
class SlimMetricSample(AIPerfBaseModel):
    ...
    Format examples:
    - Counter/Gauge: {"labels": {...}, "value": 42.0}
    - Histogram: {"labels": {...}, "histogram": [10, 25, 50, ...], "sum": 100.0, "count": 50}
    - Summary: {"labels": {...}, "summary": [0.5, 0.95, 0.99, ...], "sum": 100.0, "count": 50}
    """
...
class ServerMetricsSlimRecord(AIPerfBaseModel):
    ...
    This record excludes static metadata (endpoint_url, kubernetes_pod_info, metric types, help text)
