...
class TestEmbeddingsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_format_payload_single_input(self, endpoint, model_endpoint):
    ...
    @pytest.mark.asyncio
    async def test_format_payload_multiple_inputs(self, endpoint, model_endpoint):
    ...
    @pytest.mark.asyncio
    async def test_format_payload_filters_empty_inputs(self, endpoint, model_endpoint):
    ...
    async def test_format_payload_max_tokens_warning(
        self, endpoint, model_endpoint, caplog
    ):
    ...
    async def test_format_payload_extra_parameters(self, model_endpoint):
        ...
        with patch(
            ...
            mock_transport.return_value = MagicMock()
            endpoint = EmbeddingsEndpoint(model_endpoint=model_endpoint)
    ...
    @pytest.mark.asyncio
    async def test_format_payload_very_long_input(self, endpoint, model_endpoint):
    ...
    @pytest.mark.asyncio
    async def test_format_payload_special_characters(self, endpoint, model_endpoint):
