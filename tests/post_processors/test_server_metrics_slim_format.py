...
class TestHistogramSlimFormat:
    ...
    async def test_histogram_with_single_bucket(self, user_config):
        ...
        sample = MetricSample(labels={}, histogram=histogram)
        family = MetricFamily(
...
class TestSummarySlimFormat:
    ...
    async def test_summary_order_preserved(self, user_config):
        ...
        sample = MetricSample(labels={}, summary=summary)
        family = MetricFamily(
...
class TestMixedMetricTypes:
    ...
    async def test_record_with_all_metric_types_exports_correctly(self, user_config):
        ...
        # Gauge
        gauge_sample = MetricSample(labels={}, value=50.0)
        ...
        histogram_sample = MetricSample(labels={}, histogram=histogram)
        ...
        summary_sample = MetricSample(labels={}, summary=summary)
...
class TestSchemaMetadata:
    ...
    def test_metadata_includes_all_schemas_for_multi_metric_record(self):
        ...
        counter = MetricSample(labels={}, value=100.0)
        histogram = HistogramData(
            buckets={"0.1": 10.0, "+Inf": 50.0}, sum=25.0, count=50.0
        )
        hist_sample = MetricSample(labels={}, histogram=histogram)
    ...
    def test_different_endpoints_have_separate_schemas(self):
        ...
        MetricSample(labels={}, histogram=histogram1)
        ...
        MetricSample(labels={}, histogram=histogram2)
